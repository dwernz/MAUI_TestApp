...
namespace TestApp.Applications.TextRPG
{
    public static class World
    {
        ...
        public const int ITEM_ID_BROKEN_SHIELD = 11;
        public const int ITEM_ID_TORN_SHIRT = 12;
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Shield(ITEM_ID_BROKEN_SHIELD, "Broken shield", "Broken shields", 0, 1));
            Items.Add(new Armor(ITEM_ID_TORN_SHIRT, "Torn shirt", "Torn shirts", 0, 1));
        }

        private static void PopulateMonsters()
        {
            // Id, Name, MaxDmg, XP, Gold, current HP, max HP
